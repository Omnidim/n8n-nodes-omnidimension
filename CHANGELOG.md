...
- Trimmed the README and security policy to the information node users need, removing internal notes.

## [0.1.3] - 2026-08-16

### Fixed

- Documented the Bulk Call resource in the README operations table, which previously listed only Agent, Call, Knowledge Base, and Phone Number.
